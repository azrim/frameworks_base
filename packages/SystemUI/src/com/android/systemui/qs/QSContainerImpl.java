...
public class QSContainerImpl extends FrameLayout implements
    ...
    private void setBackgroundBottom(int value) {
        ...
        mBackgroundImage.setBottom(value);
    ...
    private void setBackgroundImage() {
        mBackgroundImage.setImageDrawable(mImage);
    }
    ...
    private void updateBackgroundImage() {
        ...
        if (imageUri != null) {
            ...
            if (mOriginalImage != null) {
                ...
                setBackgroundImage();
                mBackgroundImage.setVisibility(show ? View.VISIBLE : View.GONE);
    ...
    public void updateExpansion(boolean animate) {
        ...
        mBackgroundImage.setTop(mQSPanelContainer.getTop());
